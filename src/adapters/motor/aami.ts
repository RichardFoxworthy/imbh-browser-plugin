...
/**
 * AAMI Motor (Car) Insurance adapter.
 *
 ...
 */
export class AamiMotorAdapter extends BaseAdapter {
  constructor() {
    super({
      id: 'aami-motor',
      name: 'AAMI Motor',
      ...
      productType: 'motor',
      logoUrl: '',
      startUrl: 'https://www.aami.com.au/car-insurance/get-quote.html',
    });
  }
  ...
  extractQuote(doc: Document): QuoteResult | null {
    // TODO: Replace placeholder selectors with real ones from the AAMI motor quote results page
