...
/**
 * Budget Direct Motor (Car) Insurance adapter.
 *
 ...
 */
export class BudgetDirectMotorAdapter extends BaseAdapter {
  constructor() {
    super({
      id: 'budget-direct-motor',
      name: 'Budget Direct Motor',
      provider: 'Budget Direct',
      productType: 'motor',
      logoUrl: '',
      startUrl: 'https://www.budgetdirect.com.au/car-insurance/get-quote.html',
    });
  }
  ...
  extractQuote(doc: Document): QuoteResult | null {
    // TODO: Replace placeholder selectors with real ones from the Budget Direct motor quote results page
