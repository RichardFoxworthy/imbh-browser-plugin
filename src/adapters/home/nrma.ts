...
/**
 * NRMA Home & Contents Insurance adapter.
 *
 ...
 */
export class NrmaHomeAdapter extends BaseAdapter {
  constructor() {
    super({
      id: 'nrma-home',
      name: 'NRMA Home & Contents',
      provider: 'NRMA',
      productType: 'home-and-contents',
      logoUrl: '',
      startUrl: 'https://www.nrma.com.au/home-insurance/get-quote',
    });
  }
  ...
  extractQuote(doc: Document): QuoteResult | null {
    // TODO: Replace placeholder selectors with real ones from the NRMA quote results page
