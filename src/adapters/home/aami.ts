...
/**
 * AAMI Home & Contents Insurance adapter.
 *
 ...
 */
export class AamiHomeAdapter extends BaseAdapter {
  constructor() {
    super({
      id: 'aami-home',
      name: 'AAMI Home & Contents',
      provider: 'AAMI',
      productType: 'home-and-contents',
      logoUrl: '',
      startUrl: 'https://www.aami.com.au/home-insurance/get-quote.html',
    });
  }
  ...
  extractQuote(doc: Document): QuoteResult | null {
    // TODO: Replace placeholder selectors with real ones from the AAMI quote results page
