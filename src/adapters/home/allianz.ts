...
/**
 * Allianz Home & Contents Insurance adapter.
 *
 ...
 */
export class AllianzHomeAdapter extends BaseAdapter {
  constructor() {
    super({
      id: 'allianz-home',
      name: 'Allianz Home & Contents',
      provider: 'Allianz',
      productType: 'home-and-contents',
      logoUrl: '',
      startUrl: 'https://www.allianz.com.au/home-insurance/get-quote',
    });
  }
  ...
  extractQuote(doc: Document): QuoteResult | null {
    // TODO: Replace placeholder selectors with real ones from the Allianz quote results page
